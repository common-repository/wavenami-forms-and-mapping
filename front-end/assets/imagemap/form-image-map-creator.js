...
var summerHtmlImageMapCreator = (function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if(data.indexOf('success') !== -1){
                                // alert('pass');
                                var data_vals = data.split(':');
                                var points_written = data_vals[1];
    ...
    var help = (function() {
        var block = utils.id('help'),
            ...
            if(block)
                var close_button = block.querySelector('.close_button');
    ...
    var info = (function() {
        ...
        if(form) {
            var header = form.querySelector('h5'),
    ...
    var from_html_form = (function() {
        var form = utils.id('from_html_wrapper'),
            ...
            if(form)
                var close_button = form.querySelector('.close_button');
    ...
    var get_image = (function() {
        ...
        var url_input = (function() {
            ...
            if(url)
                var url_clear_button = url.parentNode.querySelector('.clear_button');
    ...
    // /maps/plot?mid=9
    // $.get("/maps/plotedit", function(data) {
    //     if(data != "is_new") {
    //
    //         // alert(data);
    //
